    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'ORGANIZATION'), (2, 'CHW')], null=True)),
            ...
            options={
                ...
                'permissions': (('is_organization', 'Can view dashboard'), ('is_chw', 'Can view chw app')),
            },
        ),
        migrations.CreateModel(
            name='OrgProfile',
